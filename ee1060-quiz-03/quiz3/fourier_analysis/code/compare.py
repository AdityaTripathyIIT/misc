...
error_rk4 = np.abs(rk4_result - ground_truth).sum()
error_rk2 = np.abs(rk2_result - ground_truth).sum()
error_trapezoidal = np.abs(trapezoidal_result - ground_truth).sum()
print(f"{error_rk4}")
print(f"{error_rk2}")
print(f"{error_trapezoidal}")
